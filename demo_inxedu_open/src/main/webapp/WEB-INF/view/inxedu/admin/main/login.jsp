...
<body>
	<div id="container">
		<div class="logo">
			<a href="http://jinqueedu.com/" target="_blank" title="金确在线教育软件 - 在线教育整体解决方案提供商">
				<img src="${ctx}/static/admin/assets/logo.png" width="200" alt="金确在线教育软件 - 在线教育整体解决方案提供商" />
			</a>
		</div>
	</div>
	...
	<div class="b-box">
		<div id="container">
			...
			<div class="login-foot">
				<span>
					Powered By <a target="_blank" href="http://www.jinqueedu.com/" style="color: #666;">前程牛科技</a>
				</span>
			</div>
		</div>
	</div>
