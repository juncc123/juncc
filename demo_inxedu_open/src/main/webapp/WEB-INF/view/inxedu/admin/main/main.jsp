...
<body>
		...
		<div id="container">
			...
			<div id="header">
				...
				<div id="top">
					<!-- Logo -->
					<div class="logo">
						<a href="http://www.jinqueedu.com/" target="_blank" title="金确在线教育软件 - 在线教育整体解决方案提供商" class="tooltip">
							<img src="${ctx}/static/admin/assets/logo.png" height="60" alt="金确在线教育软件 - 在线教育整体解决方案提供商" />
						</a>
					</div>
					<!-- End of Logo -->
	...
	<div id="footer">
		...
		<p class="mid">
			Powered By <a target="_blank" href="http://qianchengniu.com/" style="color: #666;">前程牛科技</a>
		</p>
	</div>
</body>
</html>
